	...
	<header class="border-b">
		...
		>
			<NavLink class="flex shrink-0" :href="links.home.href">
				...
				<NuxtImg
					alt=""
					class="mr-3 mb-2 block h-full w-44 object-contain object-left sm:mr-4 md:mr-6 dark:hidden"
					preload
					:src="project.logos.light"
				/>
				<NuxtImg
					alt=""
					class="mr-3 mb-2 block hidden h-full w-44 object-contain object-left sm:mr-4 md:mr-6 dark:block"
					preload
